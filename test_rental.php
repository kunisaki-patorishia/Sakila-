...
<body>
    <header>
        <center><h2>Sakila DVD Renting Company</h2></center>
    </header>
    <main>
        <center><h4>List of Outstanding Rentals</h4></center>
        <?php if (isset($_SESSION['msg'])): ?>
            <div class="msg">
                <?php 
                    echo $_SESSION['msg'];
        ...
        <form method="post" action="server_test_rental.php" class="form-container">
            <?php if ($edit_state == false): ?>        
                <input type="hidden" name="rental_id" value="<?php echo $rental_id ?>">
                <label>Rental Date:</label>
                <input type="text" name="rental_date" value="<?php echo $rental_date; ?>" readonly><br>
            ...
            <?php else: ?>
                ...
                <label>Return Date:</label>
                <?php $return_date = date("Y-m-d H:i:s"); ?>
                <input type="text" name="return_date" value="<?php echo $return_date; ?>" readonly><br>
            ...
            <p>Placing Rental: Fill in the form and click "Save"</p>
            <p>Closing Rental: Click "Return" at the top section, then "Update". Only Staff ID is changeable.</p>
        </form>
    </main>
    <footer>
        <center><div><h6>&copy; 2021 Group_3__10_4_Sakila DVD Renting</h6></div></center>
    </footer>
</body>
</html>
